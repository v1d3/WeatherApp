...
public class UserActivityService {
    ...
    private Activity createNewCustomActivity(UserEntity user, DefaultActivity defaultActivity,
        ...
        newActivity.setName(modificationDTO.name() != null ? modificationDTO.name() : defaultActivity.getName());
        ...
        newActivity.setMinTemperature(modificationDTO.minTemperature() != null ? modificationDTO.minTemperature()
                : defaultActivity.getMinTemperature());
        newActivity.setMaxTemperature(modificationDTO.maxTemperature() != null ? modificationDTO.maxTemperature()
                : defaultActivity.getMaxTemperature());

        // Set humidity limits
        newActivity.setMinHumidity(modificationDTO.minHumidity() != null ? modificationDTO.minHumidity()
                : defaultActivity.getMinHumidity());
        newActivity.setMaxHumidity(modificationDTO.maxHumidity() != null ? modificationDTO.maxHumidity()
                : defaultActivity.getMaxHumidity());

        // Set wind speed limits
        newActivity.setMinWindSpeed(modificationDTO.minWindSpeed() != null ? modificationDTO.minWindSpeed()
                : defaultActivity.getMinWindSpeed());
        newActivity.setMaxWindSpeed(modificationDTO.maxWindSpeed() != null ? modificationDTO.maxWindSpeed()
                : defaultActivity.getMaxWindSpeed());
        ...
        // Set weight
        newActivity.setWeight(modificationDTO.weight() != null ? modificationDTO.weight() : 1.0);
