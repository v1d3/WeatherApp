//DTO -> Si quiero pasar una lista al frontend no es bueno pasar la entidad entera, hacer entidad intermedia "DTO"
...
public class WeatherController {
    ...
    public ResponseEntity<List<WeatherDataResponseDTO>> searchWeatherData(
            @RequestParam(required = false) String location, @RequestParam(required = false) String dateTime) {
        try {
            ...
            if (weathers != null) {
                return ResponseEntity.ok(weathers.stream().map(weather -> new WeatherDataResponseDTO(weather.getId(),
                        ...
                        weather.getDateTime(), weather.getLocation(), weather.getTemperature(), weather.getHumidity(),
    ...
    public ResponseEntity<WeatherDataResponseDTO> createWeatherData(
            @Valid @RequestBody WeatherDataCreationDTO weatheDataDTO) {
        ...
        WeatherDataResponseDTO weatherDataResponseDTO = new WeatherDataResponseDTO(newWeather.getId(),
                ...
                newWeather.getDateTime(), newWeather.getLocation(), newWeather.getTemperature(),
                newWeather.getHumidity(), newWeather.getWindSpeed());
